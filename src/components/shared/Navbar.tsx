    ...
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 tracking-[0.2em] font-mono uppercase">
            {NAV_LINKS.map((link) => (
              <Link 
                key={link.label} 
                href={link.href} 
          ...
          <div className="flex items-center gap-6 tracking-[0.2em] font-mono">
            ...
            <button 
              ...
              className="lg:hidden p-2 hover:text-accent-cyan transition-colors"
            >
            ...
            <div className="flex flex-col gap-6 text-left">
              ...
              {NAV_LINKS.map((link) => (
                <Link 
                  ...
                  className="text-xl font-black tracking-tighter text-zinc-100 hover:text-accent-cyan transition-colors uppercase flex items-center justify-between group"
                >
                  {link.label}
