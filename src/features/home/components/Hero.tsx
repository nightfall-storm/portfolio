...
export function Hero() {
  const containerVariants: HeroVariants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
      transition: {
      ...
      >
        ...
        <div className="flex flex-col items-start lg:pr-12">
          ...
          <motion.div variants={itemVariants} className="max-w-xl">
            ...
            <p className="font-mono text-[10px] sm:text-[11px] md:text-xs leading-relaxed text-muted-foreground uppercase tracking-widest mb-10 lg:mb-14 max-w-lg text-balance text-left">
              ...
              while architecting scalable frontend systems. Currently expanding 
        ...
        >
          ...
          <div className="space-y-4 lg:space-y-6">
            <div>
              <span className="text-accent-cyan/60 tracking-widest">&quot;environment&quot;:</span> &#123;
              <div className="pl-6 sm:pl-8 text-foreground/90">
                &quot;OS&quot;: [&quot;FEDORA&quot;, &quot;UBUNTU&quot;, &quot;WINDOWS&quot;],<br />
                &quot;EDITOR&quot;: &quot;ZED&quot;,<br />
                &quot;SHELL&quot;: &quot;FISH&quot;
              </div>
              &#125;,
